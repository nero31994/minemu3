document.addEventListener('DOMContentLoaded', async function () {
        ...
        lines.forEach(line => {
            ...
            if (line.startsWith("#EXTINF")) {
                ...
                if (currentChannel) {
                    ...
                    currentChannel.key[keyParts[0]] = keyParts[1];
                }
    ...
    function generateChannelList() {
        ...
        channels.forEach((channel, index) => {
            ...
            btn.className = "channel-btn btn btn-dark d-flex align-items-center w-100";
            btn.innerHTML = `<img class="channel-logo me-2" src="${channel.logo}" alt="${channel.name}"> ${channel.name}`;
